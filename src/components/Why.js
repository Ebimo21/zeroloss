...
const Why = () => {
  return (
    <section className='flex flex-wrap text-center sm:text-left flex-col-reverse items-center justify-center sm:flex-row gap-10  bg-slate-700 text-white px-4 py-10'>
        ...
        <div className='basis-5/12'>
            <img src={"/images/Zeroloss_inside.png"} alt="just another arndom text" width="300px" />
        </div>
    </section>
  )
}
